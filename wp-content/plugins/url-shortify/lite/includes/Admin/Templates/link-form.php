            ...
            <div id="post-body-content">
                <div class="bg-white rounded-lg shadow-md meta-box-sortables ui-sortable">
                    <form class="flex-row pt-8 mt-2 ml-5 mr-4 text-left item-center" method="post" action="<?php echo $form_action; ?>">
                                        ...
                                        <div class="relative h-10">
                                            <select class="relative border border-gray-400 shadow-sm form-select" name="form_data[rules][domain]" id="">
												<?php foreach ( $domains as $value => $option ) { ?>
                                                    <option value="<?php echo $value; ?>"
														<?php
														if ( Helper::get_data( $rules, 'domain', '' ) == $value ) {
															echo 'selected=selected';
														}
														?>
                                                    > <?php echo $option; ?> </option>
											...
											<?php } else { ?>
                                                <h3 class="text-sm leading-5 font-medium text-green-800"><?php echo sprintf( __( 'Want to use shortlinks with custom domains? <a href="%s">Upgrade Now</a>', 'url-shortify' ), US()->get_pricing_url() ); ?></h3>
											<?php } ?>
                                    ...
                                    <div class="flex flex-row w-full">
                                        ...
                                        <div class="flex">
                                            <div class="pt-3 mb-4 ml-16 mr-4">
												...
												<span class="relative">
													<input id="<?php echo $key; ?>" type="checkbox" class="absolute w-0 h-0 opacity-0  kc-us-check-toggle" name="form_data[<?php echo $key; ?>]" value="1" 
																		  <?php
													...
													<span class="relative block w-10 h-6 bg-gray-300 rounded-full shadow-inner kc-us-toggle-line"></span>
													<span class="absolute inset-y-0 left-0 block w-4 h-4 mt-1 ml-1 transition-all duration-300 ease-in-out bg-white rounded-full shadow kc-us-toggle-dot focus-within:shadow-outline"></span>
												</span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="h-10 mt-6 mb-4 ml-16 mr-4">
                                        <div class="relative h-10">
                                            <div class="flex rounded bg-blue-50">
                                                ...
                                                <div class="ml-3">
                                                    <h3 class="text-sm leading-5 font-medium text-green-800">
														<?php echo sprintf( __( 'Set expiry date of the link with PRO version. <a href="%s">Upgrade Now</a>', 'url-shortify' ), US()->get_pricing_url() ); ?>
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <p class="submit"><input type="submit" name="submit" id="" class="px-4 py-2 ml-6 mr-2 align-middle cursor-pointer kc-us-primary-button" value="<?php echo $button_text; ?>"/><a href="admin.php?page=us_links"
