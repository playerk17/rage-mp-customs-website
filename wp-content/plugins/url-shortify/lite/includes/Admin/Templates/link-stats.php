...
$short_link = Helper::get_data( $data, 'short_url', '' );
                ...
                <div class="container mx-auto">
                    <div class="md:flex">
                        <div class="flex inline -mb-px mr-8 w-11/12">
								<span class="flex">
									<img class="h-6 w-6 mr-2" src="<?php echo $data['icon_url']; ?>" title="<?php echo $data['url']; ?>"/>
							...
							<?php
							$link = Helper::get_short_link( $data['slug'] );

							echo Helper::create_copy_short_link_html( $link, $data['id'] );
							?>
                        </div>
        ...
        <div class="mt-5">
            <div class="grid grid-cols-1">
                <div class="mt-2 flex w-full border-b-2 border-gray-100">
                    ...
                    <div class="w-5/12">
                        <div class="inline">
							<span class="rounded-md shadow-sm float-right mr-3">
